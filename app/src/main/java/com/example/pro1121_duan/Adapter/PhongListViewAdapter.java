...
public class PhongListViewAdapter extends BaseAdapter {

    List<DangTin> dangTinList;

    public PhongListViewAdapter(List<DangTin> dangTinList){
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        view = LayoutInflater.from(viewGroup.getContext()).inflate(R.layout.row_listview,viewGroup,false);
